...
**[Start Extraction →](/extract/)**

### Programmatic Library

Build graphs in TypeScript for custom tooling or build pipelines.

**[Library Quick Start →](./quick-start)** | [CLI Quick Start](./cli-quick-start) | [Library vs CLI](./library-vs-cli)

## Learn More

- [Core Concepts](/reference/schema/graph-structure) — Components, links, domains
- [CLI Reference](/reference/cli/) — Command documentation
- [API Reference](/reference/api/) — TypeScript library docs
- [Resources](./resources) — Examples and additional materials
